...
- [Making an issue](https://help.github.com/articles/creating-an-issue/). A well described issue helps a lot. (Have a look at the [known issues](https://github.com/search?q=user%3Acjsteel+is%3Aissue+state%3Aopen).)
...
When you spot an issue, [create an issue](https://github.com/cjsteel/raw/issues).

Making the issue help me and others to find similar problems in the future.

### [2. Fork the project.](#2-fork-the-project)

On the top right side of [the repository on GitHub](https://github.com/cjsteel/raw), click `fork`. This copies everything to your GitHub namespace.
...
```
git clone git@github.com:YOURNAMESPACE/ansible-role-raw.git
```
...
You can use [Ansible Generator](https://github.com/cjsteel/ansible-generator) to regenerate all dynamic content.
...
Please consider [sponsoring me](https://github.com/sponsors/cjsteel)
